...
clean_all() {
    ...
    cmake --build cmake-build-debug-coverage --target clean
...
build_all() {
    ...
    cmake --build cmake-build-debug-coverage --target all
...
install_all() {
    ...
    cmake --build cmake-build-debug-coverage --target install
